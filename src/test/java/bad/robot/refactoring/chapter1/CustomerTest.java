...
public class CustomerTest {
    ...
    private static final Movie THE_HULK = new Movie("The Hulk", Price.CHILDREN);
    private static final Movie IRON_MAN = new Movie("Iron Man 4", Price.NEW_RELEASE);
    private static final Movie SPIDER_MAN = new Movie("Spiderman", Price.REGULAR);
